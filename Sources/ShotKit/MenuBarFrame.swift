...
public struct MenuBarFrame<StatusItem: View, Content: View>: View {
    ...
    /// How many neighbouring glyphs to draw to the left of the app's item.
    public var leadingItems: Int
    ...
    private var menuBar: some View {
        HStack(spacing: 14) {
            ...
            ForEach(0..<max(0, leadingItems), id: \.self) { index in
...
private struct NeighbourGlyph: View {
    ...
    private var symbol: String {
        let symbols = ["wifi", "battery.75", "speaker.wave.2", "magnifyingglass", "bolt"]
